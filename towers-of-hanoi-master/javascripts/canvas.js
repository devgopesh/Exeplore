...
Canvas.prototype.set_width = function(width) {
  this.canvas.width = this.width = 740;
  //biggest(window.innerWidth, width); // this.width can be queried by external agents.
}

Canvas.prototype.set_height = function(height) {
  this.canvas.height = this.height = 500;
  //height; // this.height can be queried by external agents.
}
