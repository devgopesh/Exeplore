...
if (localStorage.math >= 1)
  m.textContent = "Max Score: " + localStorage.getItem('maxMathScore');
      ...
      if(cells[i][j].value) {
        ...
        while (coll + 1 < 4) {
          if (!cells[i][coll + 1].value) {
            ...
            if (localStorage.math) {
            localStorage.math = Number(localStorage.math)+1;
            } else {
                localStorage.math = 1;
            }
            if (localStorage.math === 1) {
              localStorage.setItem('maxMathScore', sc);    
            } else {
              var q = localStorage.getItem('maxMathScore');
              if (sc > q)
                localStorage.setItem('maxMathScore', sc);
            }
            m.textContent = "Max Score: " + localStorage.getItem('maxMathScore');
